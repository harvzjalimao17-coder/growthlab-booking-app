...
): AutomationCapabilitySlug | undefined {
...
export default async function BookPage({
  ...
  const automationSlug = resolveSlug(resolvedSearchParams.automation);

  const capabilityName = AUTOMATION_CAPABILITIES.find(
    (c) => c.slug === automationSlug
  )?.name;
